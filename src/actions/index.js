...
export const isTweetLiked = tweet =>
  tweet.likes && !!tweet.likes[localStorage.getItem("userId")];
export const isTweetOwner = tweet =>
  tweet.owner === localStorage.getItem("userId");
